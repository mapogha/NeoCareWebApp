                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="../functions/admin/create-doctor.php" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input
                                                ...
                                                name="hospital_name"
                                                class="form-control"
                                                value="<?= htmlspecialchars($hospital['hospital_name']) ?>"
                                                readonly
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-10">
                                            <input type="submit" name="submit" class="btn btn-primary" value="Create Doctor">
                                        </div>
                                    </div>
                                </form>
