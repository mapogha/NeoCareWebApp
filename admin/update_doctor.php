...
$doctor_stmt = $conn->prepare("SELECT * FROM users WHERE id = :id AND role = 'doctor'");
            ...
            <div class="col-xxl">
              <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5 class="mb-0">Update Doctor Details</h5>
                  <small class="text-muted float-end">Update the doctor's profile</small>
                </div>
                <div class="card-body">
                  <form action="../functions/admin/update-doctor.php" method="post">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($doctor['id'] ?? '') ?>">
                    ...
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="name">Doctor Name</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($doctor['name'] ?? '') ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="phone_number" name="phone_number" value="<?= htmlspecialchars($doctor['phone_number'] ?? '') ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="license_number" name="license_number" value="<?= htmlspecialchars($doctor['license_number'] ?? '') ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="specialization" name="specialization" value="<?= htmlspecialchars($doctor['specialization'] ?? '') ?>">
                      </div>
                    </div>
