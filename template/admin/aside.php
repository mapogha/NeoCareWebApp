<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Hospital Management (Only visible to Admin) -->
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-bar-chart-alt-2"></i>
        <div data-i18n="Hospital Management">Hospitals</div>
      </a>
      <ul class="menu-sub">
        <!-- Add Hospital -->
        <li class="menu-item">
          <a href="create_hospital.php" class="menu-link">
            <div data-i18n="Add Hospital">Add Hospital</div>
          </a>
        </li>
        <!-- View Hospitals -->
        <li class="menu-item">
          <a href="view_hospitals.php" class="menu-link">
            <div data-i18n="View Hospitals">View Hospitals</div>
          </a>
        </li>
      </ul>
    </li>
